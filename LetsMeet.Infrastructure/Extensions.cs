...
public static class Extensions
{
    ...
    {
        services.AddIdentity<AppUser, IdentityRole<Guid>>(opt => opt.User.AllowedUserNameCharacters = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789ąćęłńóśźżĄĆĘŁŃÓŚŹŻ")
